      ...
      <div class="navbar-vertical navbar nav-dashboard">
          <div class="h-100" data-simplebar>
              ...
              <ul class="navbar-nav flex-column" id="sideNavbar">
                  ...
                  <li class="nav-item">
                      <a class="nav-link has-arrow @if (in_array(request()->segment(1), ['categories'])) active @endif "
                  ...
                  <li class="nav-item">
                      ...
                      <div id="navlayoutPage" class="collapse @if (in_array(request()->segment(2), ['config', 'profile'])) show @else @endif"
                          data-bs-parent="#sideNavbar">
                          <ul class="nav flex-column">
                              @if (in_array(auth()->user()->role, ['admin', 'manager']))
                                  <li class="nav-item">
                                      <a class="nav-link " href="{{ route('settings') }}">Config</a>
                                  </li>
                              @endif
