                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{-- <div class="custom-select-container">
                                            <div class="custom-select-box" id="customSelectBox">
                                                <input type="text" class="custom-select-search" id="searchInput"
                                                    placeholder="Search customers..." readonly />
                                                <ul class="custom-select-options" id="optionsList">
                                                    @foreach ($customers as $customer)
                                                        <li class="custom-select-item"
                                                            data-value="{{ $customer->id }}"
                                                            data-label="{{ $customer->name }} ({{ $customer->phone ?? 'No Phone' }})">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        <div class="w-100 mt-3">
                                            <button wire:click="validateAndShowModal" wire:loading.attr="disabled"
                                                wire:target="validateAndShowModal"
                                                class="btn btn-warning w-100 position-relative">

                                                <span wire:loading.remove wire:target="validateAndShowModal">
                                                    Proceed to Save Order
                                                </span>
                                                <span wire:loading wire:target="validateAndShowModal">
                                                    <span class="spinner-border spinner-border-sm" role="status"
                                                        aria-hidden="true"></span>
                                                    Processing Order...
                                                </span>
