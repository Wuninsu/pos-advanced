    ...
    <div wire:ignore.self class="modal fade" id="thermalModal" tabindex="-1" aria-labelledby="customModalLabel"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                        ...
                        @if (isset($order) && $order)
                            ...
                            <div>
                                <table class="table-bg">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="4" align="right" class="th"><span>SubTotal</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="4" align="right" class="th"><span>Discount</span>
                                            </td>
                                            <td colspan="2" class="td" align="right"><span
                ...
                <div class="modal-footer">
                    @if (isset($order) && $order)
                        <button wire:click="getLastOrder" class="btn btn-primary mb-2 w-100"
