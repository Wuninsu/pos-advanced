                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    Hello {{ $recipient_name }}! Forgot your password?
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Best regards, <br><strong>Edge Digital Solutions</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td style="padding: 24px 0 48px; font-size: 0px;">
                                    ...
                                    <div class="outlook-group-fix"
                                        ...
                                        <span
                                            style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Echo
                                            Edge Digital Solutions<br />Kuani Tamale Ghana</span>
                                    </div>
